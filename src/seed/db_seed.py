...
try:
    ...
    # Verificar si ya hay datos en la tabla calzado para evitar duplicados al ejecutar el seed
    # ¡IMPORTANTE!: Usar nombres de tabla en minúsculas en todas las consultas SQL
    cursor.execute("SELECT COUNT(*) FROM calzado")
    cantidad_calzados_existentes = cursor.fetchone()[0]
    if cantidad_calzados_existentes > 0:
        print("La tabla 'calzado' ya contiene datos. No se insertarán datos duplicados.")
    else:
        print("Ejecutando seed (insertando datos iniciales)...")
        # Insertar usuarios
        usuarios_to_seed = [
        ...
        for username, password, role in usuarios_to_seed:
        ...
        if cursor.fetchone()[0] == 0:
            ...
            print("La tabla 'cuadrante' ya contiene datos, omitiendo inserción.\n")
        ...
        if cursor.fetchone()[0] == 0:
            ...
            print("La tabla 'formageometrica' ya contiene datos, omitiendo inserción.\n")
        # Insertar modelos
        ...
        if cursor.fetchone()[0] == 0:
            ...
            print("La tabla 'modelo' ya contiene datos, omitiendo inserción.\n")
        # Insertar colores
        ...
        if cursor.fetchone()[0] == 0:
            ...
            print("La tabla 'colores' ya contiene datos, omitiendo inserción.\n")
        # Insertar categorías
        ...
        if cursor.fetchone()[0] == 0:
            ...
            print("La tabla 'categoria' ya contiene datos, omitiendo inserción.\n")
        # Insertar marcas
        ...
        if cursor.fetchone()[0] == 0:
            ...
            marcas = [
                ...
                "Converse", "Puma", "Vans", "Reebok", "New Balance"
            ]
            ...
            print("La tabla 'marca' ya contiene datos, omitiendo inserción.\n")
        ...
        if cantidad_calzados_existentes == 0: 
            print("Insertando calzados y datos relacionados (suelas, detallesuela, calzado_color)...")
            ...
            if not (marca_ids and modelo_ids and categoria_ids and color_ids):
                ...
                print("\nDatos por defecto insertados exitosamente.")
        else:
